/*! sprintf-js | Alexandru Marasteanu <hello@alexei.ro> (http://alexei.ro/) | BSD-3-Clause */ ! function (a) {
	function b() {
		var a = arguments[0],
			c = b.cache;
		...
		for (var b = a, c = [], d = [], f = 0; b;) {
			if (null !== (c = e.text.exec(b))) d[d.length] = c[0];
				...
				if (c[2]) {
					...
					c[2] = g
				} else f |= 2; if (3 === f) throw new Error("[sprintf] mixing positional and named placeholders is not (yet) supported");
				d[d.length] = c
			}
